            ...
            <div class="ui teal segment" style="border-top: 2px solid rgb(212, 70, 30) !important;">
                ...
                <div class="field">
                    <div class="ui left icon input">
                        ...
                        <input name="DBLink" placeholder="Путь к БД (Например: jdbc:oracle:thin:@localhost:1521:XE)"
                               type="text" value="jdbc:oracle:thin:@localhost:1521:XE">
                    </div>
                </div>
                <div class="field">
                    <div class="ui left icon input">
                ...
                <button class="ui fluid large teal submit button" type="submit"
                        style="background-color: rgb(212, 70, 30);">Вход
                </button>
            </div>
        </form>
    </div>
